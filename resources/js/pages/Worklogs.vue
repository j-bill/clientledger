  ...
  <v-container>
      ...
      <v-card-text>
        ...
        <v-row>
          ...
          <v-col cols="12" class="text-right">
            <v-btn color="primary" @click="fetchWorkLogs">
              Apply Filters
            </v-btn>
    ...
    <v-dialog v-model="deleteDialog" max-width="500px">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="error" @click="deleteWorkLog">Delete</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="createDialog" max-width="800px">
      <v-card>
        ...
        <v-card-text>
          <work-log-form ref="createForm" :projects="projects" @save="saveWorkLog"></work-log-form>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
    ...
    <v-dialog v-model="editDialog" max-width="800px">
      <v-card>
        ...
        <v-card-text>
          <work-log-form ref="editForm" :work-log="currentWorkLog" :projects="projects" @save="updateWorkLog"></work-log-form>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
  ...
  methods: {
    ...
    async fetchWorkLogs() {
      ...
      try {
        ...
        const response = await axios.get('/api/work-logs', { params });
