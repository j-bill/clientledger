<template>
	<div class="mx-auto max-w-3xl px-4 py-8 sm:px-6">
		<h1 class="text-2xl font-semibold tracking-tight">Imprint</h1>
		<p class="mt-1 text-sm text-bone-500">Legal information and contact</p>

		<div class="mt-8">
			<!-- Loading state -->
			<div v-if="loading" class="flex flex-col items-center py-12">
				<ui-spinner :size="32" />
				<p class="mt-4 text-sm text-bone-500">Loading imprint...</p>
			</div>

			<!-- No content state -->
			<div v-else-if="!content" class="py-12 text-center">
				<p class="text-bone-300">No imprint available</p>
		...
		<div class="flex items-center justify-between">
			...
			<ui-button variant="ghost" @click="$router.push({ name: 'Privacy' })">
				View Privacy Notice
